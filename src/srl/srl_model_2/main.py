...
from srl.srl_model_2.experiment import Experiment
from srl.srl_model_2.utils import get_srl_model_name
...
def main():
    ...
    parser.add_argument('-adapter_lr', help="Adapter learning rate",
